  ...
  on_supported_os.each do |os, facts|
    ...
    context "on #{os}" do
      ...
      describe 'Puppet Server CA related settings' do
        ...
        context 'when server_puppetserver_version >= 6.0.0 and < 7.0.0' do
          ...
          context 'with default parameters' do
            ...
            it { should contain_file(auth_conf).with_ensure('file').with_content(/^( *)pp_cli_auth: "true"$/) }
          end
        ...
        context 'when server_puppetserver_version >= 7.0.0' do
          ...
          context 'with default parameters' do
            it { should contain_file(auth_conf).with_ensure('absent') }
          end
      end
